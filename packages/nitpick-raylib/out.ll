; ModuleID = 'tests/test_gui.npk'
source_filename = "tests/test_gui.npk"
...
@.str.data = private constant [26 x i8] c"Nitpick Raylib Prototype\00\00"
@.str = private constant %struct.NpkString { ptr @.str.data, i64 25 }
@.str.data.1 = private constant [5 x i8] c"A S\00\00"
@.str.2 = private constant %struct.NpkString { ptr @.str.data.1, i64 4 }
@.str.data.3 = private constant [6 x i8] c"10 H\00\00"
@.str.4 = private constant %struct.NpkString { ptr @.str.data.3, i64 5 }
@.str.data.5 = private constant [30 x i8] c"Hello from Raylib + Nitpick!\00\00"
...
whilecond:                                        ; preds = %whilebody, %entry
  %calltmp3 = call { i32, ptr, i8 } @rl_window_should_close()
  %raw.value4 = extractvalue { i32, ptr, i8 } %calltmp3, 0
  %eqtmp = icmp eq i32 %raw.value4, 0
  %whilecond5 = icmp ne i1 %eqtmp, false
  br i1 %whilecond5, label %whilebody, label %afterwhile

whilebody:                                        ; preds = %whilecond
  %calltmp6 = call { %struct.NIL, ptr, i8 } @rl_begin_drawing()
  %raw.value7 = extractvalue { %struct.NIL, ptr, i8 } %calltmp6, 0
  %calltmp8 = call { %struct.NIL, ptr, i8 } @rl_clear_background(i32 30, i32 30, i32 30, i32 255)
  %raw.value9 = extractvalue { %struct.NIL, ptr, i8 } %calltmp8, 0
  %calltmp10 = call { %struct.NIL, ptr, i8 } @rl_draw_rectangle(i32 100, i32 100, i32 600, i32 400, i32 34, i32 139, i32 34, i32 255)
  %raw.value11 = extractvalue { %struct.NIL, ptr, i8 } %calltmp10, 0
  %calltmp12 = call { %struct.NIL, ptr, i8 } @rl_draw_rectangle(i32 300, i32 200, i32 80, i32 120, i32 255, i32 255, i32 255, i32 255)
  %raw.value13 = extractvalue { %struct.NIL, ptr, i8 } %calltmp12, 0
  %calltmp14 = call { %struct.NIL, ptr, i8 } @rl_draw_rectangle_lines(i32 300, i32 200, i32 80, i32 120, i32 0, i32 0, i32 0, i32 255)
  %raw.value15 = extractvalue { %struct.NIL, ptr, i8 } %calltmp14, 0
  %calltmp16 = call { %struct.NIL, ptr, i8 } @rl_draw_text(ptr @.str.2, i32 310, i32 210, i32 20, i32 0, i32 0, i32 0, i32 255)
  %raw.value17 = extractvalue { %struct.NIL, ptr, i8 } %calltmp16, 0
  %calltmp18 = call { %struct.NIL, ptr, i8 } @rl_draw_rectangle(i32 400, i32 200, i32 80, i32 120, i32 255, i32 255, i32 255, i32 255)
  %raw.value19 = extractvalue { %struct.NIL, ptr, i8 } %calltmp18, 0
  %calltmp20 = call { %struct.NIL, ptr, i8 } @rl_draw_rectangle_lines(i32 400, i32 200, i32 80, i32 120, i32 0, i32 0, i32 0, i32 255)
  %raw.value21 = extractvalue { %struct.NIL, ptr, i8 } %calltmp20, 0
  %calltmp22 = call { %struct.NIL, ptr, i8 } @rl_draw_text(ptr @.str.4, i32 410, i32 210, i32 20, i32 200, i32 0, i32 0, i32 255)
  %raw.value23 = extractvalue { %struct.NIL, ptr, i8 } %calltmp22, 0
  %calltmp24 = call { %struct.NIL, ptr, i8 } @rl_draw_text(ptr @.str.6, i32 250, i32 50, i32 20, i32 255, i32 255, i32 255, i32 255)
  %raw.value25 = extractvalue { %struct.NIL, ptr, i8 } %calltmp24, 0
  %calltmp26 = call { %struct.NIL, ptr, i8 } @rl_draw_fps(i32 10, i32 10)
  %raw.value27 = extractvalue { %struct.NIL, ptr, i8 } %calltmp26, 0
  %calltmp28 = call { %struct.NIL, ptr, i8 } @rl_end_drawing()
  %raw.value29 = extractvalue { %struct.NIL, ptr, i8 } %calltmp28, 0
  call void @npk_gc_safepoint()
  br label %whilecond

afterwhile:                                       ; preds = %whilecond
  %calltmp30 = call { %struct.NIL, ptr, i8 } @rl_close_window()
  %raw.value31 = extractvalue { %struct.NIL, ptr, i8 } %calltmp30, 0
