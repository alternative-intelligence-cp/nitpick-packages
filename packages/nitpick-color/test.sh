...
echo "Compiling test_nitpick_color..."
/home/randy/Workspace/REPOS/nitpick/build/npkc tests/test_nitpick_color.npk \
    -I src \
    --emit-llvm -o out_test.ll

sed -i 's/getelementptr inbounds nuw/getelementptr inbounds/g' out_test.ll

echo "Linking test_nitpick_color..."
clang++ -O1 out_test.ll \
    ...
    -o test_nitpick_color

echo "Running test_nitpick_color..."
./test_nitpick_color
