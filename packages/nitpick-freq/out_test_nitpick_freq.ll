; ModuleID = 'tests/test_nitpick_freq.npk'
source_filename = "tests/test_nitpick_freq.npk"
...
@.str.data = private constant [30 x i8] c"PASS: T01 hz_to_ns(1Hz)=1e9ns\00"
@.str = private constant %struct.NpkString { ptr @.str.data, i64 29 }
@.str.data.1 = private constant [30 x i8] c"FAIL: T01 hz_to_ns(1Hz)=1e9ns\00"
@.str.2 = private constant %struct.NpkString { ptr @.str.data.1, i64 29 }
@.str.data.3 = private constant [29 x i8] c"PASS: T02 hz_to_ns(1kHz)=1ms\00"
@.str.4 = private constant %struct.NpkString { ptr @.str.data.3, i64 28 }
@.str.data.5 = private constant [29 x i8] c"FAIL: T02 hz_to_ns(1kHz)=1ms\00"
@.str.6 = private constant %struct.NpkString { ptr @.str.data.5, i64 28 }
@.str.data.7 = private constant [24 x i8] c"PASS: T03 hz_to_ns(0)=0\00"
@.str.8 = private constant %struct.NpkString { ptr @.str.data.7, i64 23 }
@.str.data.9 = private constant [24 x i8] c"FAIL: T03 hz_to_ns(0)=0\00"
@.str.10 = private constant %struct.NpkString { ptr @.str.data.9, i64 23 }
@.str.data.11 = private constant [30 x i8] c"PASS: T04 ns_to_hz(1e9ns)=1Hz\00"
@.str.12 = private constant %struct.NpkString { ptr @.str.data.11, i64 29 }
@.str.data.13 = private constant [30 x i8] c"FAIL: T04 ns_to_hz(1e9ns)=1Hz\00"
@.str.14 = private constant %struct.NpkString { ptr @.str.data.13, i64 29 }
@.str.data.15 = private constant [32 x i8] c"PASS: T05 ns_to_hz(1000ns)=1MHz\00"
@.str.16 = private constant %struct.NpkString { ptr @.str.data.15, i64 31 }
@.str.data.17 = private constant [32 x i8] c"FAIL: T05 ns_to_hz(1000ns)=1MHz\00"
@.str.18 = private constant %struct.NpkString { ptr @.str.data.17, i64 31 }
@.str.data.19 = private constant [28 x i8] c"PASS: T06 mhz_to_hz(100MHz)\00"
@.str.20 = private constant %struct.NpkString { ptr @.str.data.19, i64 27 }
@.str.data.21 = private constant [28 x i8] c"FAIL: T06 mhz_to_hz(100MHz)\00"
@.str.22 = private constant %struct.NpkString { ptr @.str.data.21, i64 27 }
@.str.data.23 = private constant [33 x i8] c"PASS: T07 hz_to_mhz(3.6GHz)=3600\00"
@.str.24 = private constant %struct.NpkString { ptr @.str.data.23, i64 32 }
@.str.data.25 = private constant [33 x i8] c"FAIL: T07 hz_to_mhz(3.6GHz)=3600\00"
@.str.26 = private constant %struct.NpkString { ptr @.str.data.25, i64 32 }
@.str.data.27 = private constant [33 x i8] c"PASS: T08 cycles_in(1GHz,1s)=1e9\00"
@.str.28 = private constant %struct.NpkString { ptr @.str.data.27, i64 32 }
@.str.data.29 = private constant [33 x i8] c"FAIL: T08 cycles_in(1GHz,1s)=1e9\00"
@.str.30 = private constant %struct.NpkString { ptr @.str.data.29, i64 32 }
@.str.data.31 = private constant [31 x i8] c"PASS: T09 cycles_in(500MHz,2s)\00"
@.str.32 = private constant %struct.NpkString { ptr @.str.data.31, i64 30 }
@.str.data.33 = private constant [31 x i8] c"FAIL: T09 cycles_in(500MHz,2s)\00"
@.str.34 = private constant %struct.NpkString { ptr @.str.data.33, i64 30 }
@.str.data.35 = private constant [31 x i8] c"PASS: T10 baud_to_bit_ns(9600)\00"
@.str.36 = private constant %struct.NpkString { ptr @.str.data.35, i64 30 }
@.str.data.37 = private constant [31 x i8] c"FAIL: T10 baud_to_bit_ns(9600)\00"
@.str.38 = private constant %struct.NpkString { ptr @.str.data.37, i64 30 }
@.str.data.39 = private constant [32 x i8] c"PASS: T11 baud_to_byte_ns(9600)\00"
@.str.40 = private constant %struct.NpkString { ptr @.str.data.39, i64 31 }
@.str.data.41 = private constant [32 x i8] c"FAIL: T11 baud_to_byte_ns(9600)\00"
@.str.42 = private constant %struct.NpkString { ptr @.str.data.41, i64 31 }
@.str.data.43 = private constant [30 x i8] c"PASS: T12 baud_to_bit_ns(0)=0\00"
@.str.44 = private constant %struct.NpkString { ptr @.str.data.43, i64 29 }
@.str.data.45 = private constant [30 x i8] c"FAIL: T12 baud_to_bit_ns(0)=0\00"
@.str.46 = private constant %struct.NpkString { ptr @.str.data.45, i64 29 }
@.str.data.47 = private constant [30 x i8] c"PASS: T13 ns_to_ms(5000000)=5\00"
@.str.48 = private constant %struct.NpkString { ptr @.str.data.47, i64 29 }
@.str.data.49 = private constant [30 x i8] c"FAIL: T13 ns_to_ms(5000000)=5\00"
@.str.50 = private constant %struct.NpkString { ptr @.str.data.49, i64 29 }
@.str.data.51 = private constant [26 x i8] c"PASS: T14 ms_to_ns(250ms)\00"
@.str.52 = private constant %struct.NpkString { ptr @.str.data.51, i64 25 }
@.str.data.53 = private constant [26 x i8] c"FAIL: T14 ms_to_ns(250ms)\00"
@.str.54 = private constant %struct.NpkString { ptr @.str.data.53, i64 25 }
@.str.data.55 = private constant [33 x i8] c"PASS: T15 roundtrip 1MHz->ns->Hz\00"
@.str.56 = private constant %struct.NpkString { ptr @.str.data.55, i64 32 }
@.str.data.57 = private constant [33 x i8] c"FAIL: T15 roundtrip 1MHz->ns->Hz\00"
...
define { i64, ptr, i8 } @hz_to_ns(i64 %hz) {
entry:
  %hz.addr = alloca i64, align 8
  store i64 %hz, ptr %hz.addr, align 4
  %result = alloca i64, align 8
  store i64 0, ptr %result, align 4
  %hz1 = load i64, ptr %hz.addr, align 4
  %gttmp = icmp ugt i64 %hz1, 0
  %ifcond = icmp ne i1 %gttmp, false
  br i1 %ifcond, label %then, label %ifcont

then:                                             ; preds = %entry
  %hz2 = load i64, ptr %hz.addr, align 4
  %div.zero.chk = icmp eq i64 %hz2, 0
  %safe.divisor = select i1 %div.zero.chk, i64 1, i64 %hz2
  %udivtmp = udiv i64 1000000000, %safe.divisor
  %divtmp = select i1 %div.zero.chk, i64 -1, i64 %udivtmp
  store i64 %divtmp, ptr %result, align 4
  br label %ifcont
...
define { i64, ptr, i8 } @ns_to_hz(i64 %ns) {
entry:
  ...
  %gttmp = icmp ugt i64 %ns1, 0
  %ifcond = icmp ne i1 %gttmp, false
  br i1 %ifcond, label %then, label %ifcont

then:                                             ; preds = %entry
  %ns2 = load i64, ptr %ns.addr, align 4
  %div.zero.chk = icmp eq i64 %ns2, 0
  %safe.divisor = select i1 %div.zero.chk, i64 1, i64 %ns2
  %udivtmp = udiv i64 1000000000, %safe.divisor
  %divtmp = select i1 %div.zero.chk, i64 -1, i64 %udivtmp
  store i64 %divtmp, ptr %result, align 4
  br label %ifcont
...
define { i64, ptr, i8 } @mhz_to_hz(i64 %mhz) {
entry:
  %mhz.addr = alloca i64, align 8
  store i64 %mhz, ptr %mhz.addr, align 4
  %r = alloca i64, align 8
  %mhz1 = load i64, ptr %mhz.addr, align 4
  %multmp = mul i64 %mhz1, 1000000
  store i64 %multmp, ptr %r, align 4
...
define { i64, ptr, i8 } @hz_to_mhz(i64 %hz) {
entry:
  %hz.addr = alloca i64, align 8
  store i64 %hz, ptr %hz.addr, align 4
  %r = alloca i64, align 8
  %hz1 = load i64, ptr %hz.addr, align 4
  %udivtmp = udiv i64 %hz1, 1000000
  %divtmp = select i1 false, i64 -1, i64 %udivtmp
  store i64 %divtmp, ptr %r, align 4
  %r2 = load i64, ptr %r, align 4
  %result.val = insertvalue { i64, ptr, i8 } undef, i64 %r2, 0
  %result.err = insertvalue { i64, ptr, i8 } %result.val, ptr null, 1
  %result.is_error = insertvalue { i64, ptr, i8 } %result.err, i8 0, 2
...
define { i64, ptr, i8 } @cycles_in(i64 %hz, i64 %duration_ns) {
entry:
  %hz.addr = alloca i64, align 8
  store i64 %hz, ptr %hz.addr, align 4
  %duration_ns.addr = alloca i64, align 8
  store i64 %duration_ns, ptr %duration_ns.addr, align 4
  %r = alloca i64, align 8
  %hz1 = load i64, ptr %hz.addr, align 4
  %duration_ns2 = load i64, ptr %duration_ns.addr, align 4
  %udivtmp = udiv i64 %duration_ns2, 1000000000
  %divtmp = select i1 false, i64 -1, i64 %udivtmp
  %multmp = mul i64 %hz1, %divtmp
  store i64 %multmp, ptr %r, align 4
...
define { i64, ptr, i8 } @baud_to_bit_ns(i64 %baud) {
entry:
  %baud.addr = alloca i64, align 8
  store i64 %baud, ptr %baud.addr, align 4
  %result = alloca i64, align 8
  store i64 0, ptr %result, align 4
  %baud1 = load i64, ptr %baud.addr, align 4
  %gttmp = icmp ugt i64 %baud1, 0
  %ifcond = icmp ne i1 %gttmp, false
  br i1 %ifcond, label %then, label %ifcont

then:                                             ; preds = %entry
  %baud2 = load i64, ptr %baud.addr, align 4
  %div.zero.chk = icmp eq i64 %baud2, 0
  %safe.divisor = select i1 %div.zero.chk, i64 1, i64 %baud2
  %udivtmp = udiv i64 1000000000, %safe.divisor
  %divtmp = select i1 %div.zero.chk, i64 -1, i64 %udivtmp
  store i64 %divtmp, ptr %result, align 4
  br label %ifcont
...
define { i64, ptr, i8 } @baud_to_byte_ns(i64 %baud) {
entry:
  %baud.addr = alloca i64, align 8
  store i64 %baud, ptr %baud.addr, align 4
  %result = alloca i64, align 8
...
define { i64, ptr, i8 } @ns_to_ms(i64 %ns) {
entry:
  %ns.addr = alloca i64, align 8
  store i64 %ns, ptr %ns.addr, align 4
  %r = alloca i64, align 8
  %ns1 = load i64, ptr %ns.addr, align 4
  %udivtmp = udiv i64 %ns1, 1000000
  %divtmp = select i1 false, i64 -1, i64 %udivtmp
  store i64 %divtmp, ptr %r, align 4
  %r2 = load i64, ptr %r, align 4
  %result.val = insertvalue { i64, ptr, i8 } undef, i64 %r2, 0
...
define i32 @__nitpick_freq_init() {
entry:
  ret i32 0
}
...
ifcont166:                                        ; preds = %else160, %then156
  ...
  %calltmp167 = call { i64, ptr, i8 } @baud_to_bit_ns(i64 0)
...
ifcont214:                                        ; preds = %else208, %then204
  ...
  store i64 1000000, ptr %orig, align 4
  %ns_val = alloca i64, align 8
  %orig215 = load i64, ptr %orig, align 4
  %calltmp216 = call { i64, ptr, i8 } @hz_to_ns(i64 %orig215)
  %raw.value217 = extractvalue { i64, ptr, i8 } %calltmp216, 0
  store i64 %raw.value217, ptr %ns_val, align 4
  %back = alloca i64, align 8
  %ns_val218 = load i64, ptr %ns_val, align 4
  %calltmp219 = call { i64, ptr, i8 } @ns_to_hz(i64 %ns_val218)
  %raw.value220 = extractvalue { i64, ptr, i8 } %calltmp219, 0
  store i64 %raw.value220, ptr %back, align 4
  %back221 = load i64, ptr %back, align 4
  %orig222 = load i64, ptr %orig, align 4
  %eqtmp223 = icmp eq i64 %back221, %orig222
  %ifcond224 = icmp ne i1 %eqtmp223, false
  br i1 %ifcond224, label %then225, label %else229

then225:                                          ; preds = %ifcont214
  %str_struct_ffi226 = load %struct.NpkString, ptr @.str.56, align 8
  %str_data_ffi227 = extractvalue %struct.NpkString %str_struct_ffi226, 0
  %calltmp228 = call i32 @puts(ptr %str_data_ffi227)
  br label %ifcont235

else229:                                          ; preds = %ifcont214
  %str_struct_ffi230 = load %struct.NpkString, ptr @.str.58, align 8
  %str_data_ffi231 = extractvalue %struct.NpkString %str_struct_ffi230, 0
  %calltmp232 = call i32 @puts(ptr %str_data_ffi231)
  %fail_cnt233 = load i32, ptr %fail_cnt, align 4
  %addtmp234 = add i32 %fail_cnt233, 1
  store i32 %addtmp234, ptr %fail_cnt, align 4
  br label %ifcont235

ifcont235:                                        ; preds = %else229, %then225
  %fail_cnt236 = load i32, ptr %fail_cnt, align 4
  %gttmp = icmp sgt i32 %fail_cnt236, 0
  %ifcond237 = icmp ne i1 %gttmp, false
  br i1 %ifcond237, label %then238, label %ifcont243

then238:                                          ; preds = %ifcont235
  %str_struct_ffi239 = load %struct.NpkString, ptr @.str.60, align 8
  %str_data_ffi240 = extractvalue %struct.NpkString %str_struct_ffi239, 0
  %fail_cnt241 = load i32, ptr %fail_cnt, align 4
  %calltmp242 = call i32 @printf(ptr %str_data_ffi240, i32 %fail_cnt241)
  call void @exit(i32 1) #0
  unreachable

ifcont243:                                        ; preds = %ifcont235
  %str_struct_ffi244 = load %struct.NpkString, ptr @.str.62, align 8
  %str_data_ffi245 = extractvalue %struct.NpkString %str_struct_ffi244, 0
  %calltmp246 = call i32 @puts(ptr %str_data_ffi245)
...
define i32 @__test_nitpick_freq_init() {
entry:
  ret i32 0
}
