...
ifcont:                                           ; preds = %else, %then
  ...
  %ignj2 = alloca i32, align 4
  %ign222 = load i64, ptr %ign2, align 4
  %calltmp23 = call { i32, ptr, i8 } @Thread_join(i64 %ign222)
  %raw.value24 = extractvalue { i32, ptr, i8 } %calltmp23, 0
  store i32 %raw.value24, ptr %ignj2, align 4
  %ignj3 = alloca i32, align 4
  %ign325 = load i64, ptr %ign3, align 4
  %calltmp26 = call { i32, ptr, i8 } @Thread_join(i64 %ign325)
  %raw.value27 = extractvalue { i32, ptr, i8 } %calltmp26, 0
  store i32 %raw.value27, ptr %ignj3, align 4
  %ignj4 = alloca i32, align 4
  %ign428 = load i64, ptr %ign4, align 4
  %calltmp29 = call { i32, ptr, i8 } @Thread_join(i64 %ign428)
  %raw.value30 = extractvalue { i32, ptr, i8 } %calltmp29, 0
  store i32 %raw.value30, ptr %ignj4, align 4
  %ign6 = alloca i32, align 4
  %wg31 = load i64, ptr %wg, align 4
  %calltmp32 = call { i32, ptr, i8 } @WaitGroup_destroy(i64 %wg31)
  %raw.value33 = extractvalue { i32, ptr, i8 } %calltmp32, 0
  store i32 %raw.value33, ptr %ign6, align 4
  %ign7 = alloca %struct.NIL, align 8
  %calltmp34 = call { %struct.NIL, ptr, i8 } @test_assert(ptr @.str.4, i32 1)
  %raw.value35 = extractvalue { %struct.NIL, ptr, i8 } %calltmp34, 0
  store %struct.NIL %raw.value35, ptr %ign7, align 1
  ret { %struct.NIL, ptr, i8 } zeroinitializer
}
...
ifcont:                                           ; preds = %else, %then
  ...
  %ignj1 = alloca i32, align 4
  %ign116 = load i64, ptr %ign1, align 4
  %calltmp17 = call { i32, ptr, i8 } @Thread_join(i64 %ign116)
  %raw.value18 = extractvalue { i32, ptr, i8 } %calltmp17, 0
  store i32 %raw.value18, ptr %ignj1, align 4
  %ignj2 = alloca i32, align 4
  %ign219 = load i64, ptr %ign2, align 4
  %calltmp20 = call { i32, ptr, i8 } @Thread_join(i64 %ign219)
  %raw.value21 = extractvalue { i32, ptr, i8 } %calltmp20, 0
  store i32 %raw.value21, ptr %ignj2, align 4
  %ign4 = alloca i32, align 4
  %latch22 = load i64, ptr %latch, align 4
  %calltmp23 = call { i32, ptr, i8 } @CountDownLatch_destroy(i64 %latch22)
  %raw.value24 = extractvalue { i32, ptr, i8 } %calltmp23, 0
  store i32 %raw.value24, ptr %ign4, align 4
  %ign5 = alloca %struct.NIL, align 8
  %calltmp25 = call { %struct.NIL, ptr, i8 } @test_assert(ptr @.str.10, i32 1)
  %raw.value26 = extractvalue { %struct.NIL, ptr, i8 } %calltmp25, 0
  store %struct.NIL %raw.value26, ptr %ign5, align 1
  ret { %struct.NIL, ptr, i8 } zeroinitializer
}
