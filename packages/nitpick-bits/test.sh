...
echo "Compiling test_nitpick_bits..."
/home/randy/Workspace/REPOS/nitpick/build/npkc tests/test_nitpick_bits.npk \
    -I src \
    --emit-llvm -o out_test.ll

sed -i 's/getelementptr inbounds nuw/getelementptr inbounds/g' out_test.ll

echo "Linking test_nitpick_bits..."
...
echo "Running test_nitpick_bits..."
./test_nitpick_bits
